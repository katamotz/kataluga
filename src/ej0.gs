...
class Ejercicio0:GLib.Object
	...
	def inicio()
		...
		iman= new Rectangulo (50,390,800,150)
		...
		var anadidas= datos.toma_alumno_letras(Random.int_range(0,3))
		for var i=0 to ultimo_de_lista(anadidas)
			palabra+=anadidas[i]
